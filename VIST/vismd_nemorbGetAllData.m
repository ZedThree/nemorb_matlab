...
% 
function [data_full, time, text, PlotOrder,coord1,coord2] =  vismd_nemorbGetAllData(FileName, dim, tag_species, DataSetName);

GroupName = ['/data/var', dim, '/', char(tag_species), '/', char(DataSetName)];
if nargout > 2,
